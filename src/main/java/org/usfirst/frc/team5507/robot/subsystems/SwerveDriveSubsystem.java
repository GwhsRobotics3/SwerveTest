...
public class SwerveDriveSubsystem extends HolonomicDrivetrain {
	...
	private SwerveDriveModule[] mSwerveModules = new SwerveDriveModule[] {
		new SwerveDriveModule(0, new TalonSRX(5), new TalonSRX(6), 75.5),
		new SwerveDriveModule(1, new TalonSRX(2), new TalonSRX(4), 13.7),
		new SwerveDriveModule(2, new TalonSRX(1), new TalonSRX(3), 254),
